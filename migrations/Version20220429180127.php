...
final class Version20220429180127 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD username VARCHAR(50) NOT NULL, ADD date_inscription DATETIME NOT NULL, ADD temps_reponse VARCHAR(20) DEFAULT NULL, ADD tã©lephone VARCHAR(50) DEFAULT NULL, ADD adresse VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP username, DROP date_inscription, DROP temps_reponse, DROP tã©lephone, DROP adresse');
    }
}
